...
CREATE TABLE  restaurante.BebidasAlcool
(
	id_BebidasAlcool char (5) not null,
	Preco_BebidasAlcool float (6) not null,
	Descricao varchar (150) not null,
	id_Ingrediente char (5) not null,
	Data_NascClienteBebi date not null,
	PRIMARY KEY (id_BebidasAlcool),
	FOREIGN KEY (id_Ingrediente) REFERENCES restaurante.Ingrediente (id_Ingrediente),
...
(
	...
	FOREIGN KEY (id_BebidasAlcool) REFERENCES restaurante.BebidasAlcool (id_BebidasAlcool),
